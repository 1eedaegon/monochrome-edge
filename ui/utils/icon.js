...
export async function createIcon(name, options = {}) {
    ...
    try {
        ...
        container.innerHTML = iconLoader.getPlaceholder(options.width || 16, options.height || 16);
    }
...
export async function setIcon(element, name, options = {}) {
    ...
    try {
        ...
        element.innerHTML = iconLoader.getPlaceholder(options.width || 16, options.height || 16);
    }
}
...
export async function createIconButton(iconName, options = {}) {
    ...
    try {
        ...
        button.innerHTML = iconLoader.getPlaceholder(options.width || 16, options.height || 16);
    }

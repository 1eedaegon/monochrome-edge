...
export class SlashMenuCore {
  constructor(editor) {
    ...
    this.commands = [
      ...
      },
      {
        ...
        keywords: ["note", "warning", "info", "tip"],
      },
      {
        id: "toggle",
        icon: "chevron-right",
  ...
  render() {
    ...
    Object.entries(categories).forEach(([category, ids]) => {
      const categoryCommands = this.filteredCommands.filter(
        (cmd) =>
